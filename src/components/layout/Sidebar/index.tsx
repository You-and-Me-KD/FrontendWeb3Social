...
export const Sidebar = () => {
  ...
  return (
    <nav className="bg-main-1 top-0 left-0 z-50 mt-[var(--header-height)] hidden h-full w-[var(--sidebar-width)] lg:fixed lg:block">
      <VStack align="center" justify="center" className="mt-6">
        <CircularProgress value={25} size={44} strokeWidth={4} />
      </VStack>
